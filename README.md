...
# NEXT_PUBLIC_SITE_URL=https://doujindesu.online

# 4. Jalankan development server
npm run dev
```

Buka [https://doujindesu.online](https://doujindesu.online)
...
| `NEXT_PUBLIC_SITE_URL` | URL website live | `https://doujindesu.online` |
