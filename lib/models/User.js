...
const userSchema = new mongoose.Schema({
  ...
  premiumAt: { type: Date, default: null },
  dailyDownloads: {
  ...
  // Pending Trakteer premium payments awaiting verification
  ...
  // Dipakai untuk hapus otomatis akun yang tidak login dalam periode tertentu.
